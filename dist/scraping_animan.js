...
const getThreadPosts = (context, isMainArea) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const list = yield Promise.all(threadItems.map((item) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const text = yield item.$eval(".t_b", (e) => { var _a; return (_a = e.textContent) !== null && _a !== void 0 ? _a : ""; });
        const textStyle = yield item.$eval(".t_b", (e) => { var _a; return (_a = e.getAttribute("style")) !== null && _a !== void 0 ? _a : ""; });
        return {
            number,
            text,
            textStyle,
